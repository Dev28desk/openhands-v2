...
echo "🔑 Adding GitHub authentication to DeskDev.ai..."
...
<body class="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 min-h-screen flex items-center justify-center">
    <div class="glass-effect p-8 max-w-md w-full">
        ...
        <div class="space-y-4">
            <a href="/api/auth/github" class="flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white py-3 px-4 rounded-lg w-full">
...
# Update the landing page to include a login button
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="/login" class="text-white hover:text-blue-200">
                        Sign In
                    </a>
                    <a href="/login" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
                        Get Started
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-20">
        <div class="text-center">
            ...
            <div class="flex justify-center space-x-4">
                <a href="/login" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold">
                    Sign Up with GitHub
                </a>
                <a href="/login" class="bg-gray-700 hover:bg-gray-600 text-white px-8 py-4 rounded-lg text-lg font-semibold">
                    Login
                </a>
            </div>
        </div>
...
# Update the landing page server to handle the login route
...
const server = http.createServer((req, res) => {
  ...
  // Handle login route
  if (pathname === '/login') {
    const loginPath = path.join('/opt/deskdev/custom/templates', 'login.html');
  ...
  if (pathname === '/app') {
    res.writeHead(302, { 'Location': 'http://31.97.61.137:3000' });
    res.end();
    return;
  }
...
# Update Nginx configuration to handle GitHub authentication
...
echo "✅ GitHub authentication added to DeskDev.ai!"
echo "🌐 Landing page: http://31.97.61.137/"
echo "🔑 Login page: http://31.97.61.137/login"